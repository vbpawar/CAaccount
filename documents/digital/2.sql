...
(6, 'IDFC', '258965588', 'IFSC121', '2020-11-22 18:18:27', '2020-11-22 18:18:27');
...
(73, 'USA', 'Winterfell', 'North', '789098', 'Winterfell north', '2020-11-22 17:47:18', '2020-11-22 17:47:18');
...
(1, 1, 1, 1, 'CLASS 1', 'Private', 'Kalptaru', 'Pune', '', NULL, '2020-11-13 18:31:18'),
(2, 1, 4, 4, 'CLASS 2', 'Private', 'Kalptaru', 'Pune', 'New', NULL, '2020-11-13 14:51:55'),
(3, 70, 6, 11, 'CLASS 2', ' Private limited', 'IDFC', 'Punawala', 'New', NULL, '2020-11-20 17:24:04');
...
(7, 'VIKAS PAWAR', 'EVVP987BN', 'VIKAS PAWAR', '636458396589', '9657613754', 'vikas.nucleon@gmail.com', '1998-03-11', '2020-11-22 18:18:27', '2020-11-22 18:18:27');
...
(5, 'sql', 1, 6, 'Aadhar', '2020-11-22 18:18:27', '2020-11-22 18:18:27'),
(6, 'pdf', 1, 6, 'PAN', '2020-11-22 18:18:27', '2020-11-22 18:18:27'),
(7, 'text', 1, 6, 'Passbook', '2020-11-22 18:18:28', '2020-11-22 18:18:28');
...
(1, 2, 1, 1, 1, NULL, NULL, '2', 'add remark test', '2020-11-14 17:37:39', '2020-11-22 17:40:46'),
(2, 2, 2, 2, 2, NULL, NULL, 'New', NULL, '2020-11-14 17:39:31', '2020-11-14 17:39:31'),
(3, 2, 3, 8, 3, NULL, NULL, 'New', NULL, '2020-11-20 00:03:41', '2020-11-20 00:03:41'),
(4, 2, 4, 9, 4, NULL, NULL, 'New', NULL, '2020-11-20 00:05:36', '2020-11-20 00:05:36'),
(5, 2, 5, 10, 5, NULL, NULL, 'New', NULL, '2020-11-20 00:07:16', '2020-11-20 00:07:16'),
(6, 70, 7, 12, 6, '12345', '12245', 'New', NULL, '2020-11-22 18:18:27', '2020-11-22 18:18:27');
...
(1, 'PF', 1, 'pdf', '2020-11-22 17:40:46', '2020-11-22 17:40:46'),
(2, 'PF', 1, 'pdf', '2020-11-22 17:40:47', '2020-11-22 17:40:47');
...
(12, 'SUPE', '12', 'GHODENADI', 'PUNE', 'Rahuri', 'SHIRUR', 'PUNE', 'Maharashtra', '147895', '2020-11-22 18:18:27', '2020-11-22 18:18:27');
...
(1, 'PF WITHDRWAL', 250.00, '2020-11-21 13:54:54', '2020-11-21 13:54:54'),
(2, 'DIGITAL SIGNATURE', 500.00, '2020-11-21 13:54:54', '2020-11-21 13:54:54');
...
(56, 2, 5, '2020-11-21 19:57:55', '2020-11-21 19:57:55'),
(57, 73, 1, '2020-11-22 17:47:18', '2020-11-22 17:47:18'),
(58, 73, 2, '2020-11-22 17:47:18', '2020-11-22 17:47:18');
...
(73, 4, 'nedstark@got.com', 'Ned', 'Stark', '12345', '9881652726', '2020-11-22 17:47:18', '2020-11-22 17:47:18');
...
(15, 70, 'Debit', 250.00, 'Debit for service', '2020-11-22 06:18:27', '2020-11-22 18:18:27', '2020-11-22 18:18:27');
...
--
ALTER TABLE `activities`
  MODIFY `activityid` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `contact_master`
  MODIFY `userid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;
...
--
ALTER TABLE `pf_docs`
  MODIFY `docid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `pf_withdrwal`
--
ALTER TABLE `pf_withdrwal`
  MODIFY `pfid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `residential_details`
  MODIFY `rid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `service_charges`
  MODIFY `chargesid` tinyint(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `user_access_control`
  MODIFY `accessid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
