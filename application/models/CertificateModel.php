...
class CertificateModel extends CI_Model {
    ...
    public function get_details($roleid,$userid) {
        ...
        $sql = "SELECT pf.certid,pf.c_type,pf.reason,pf.buss_address,pf.status,pf.remark,pf.updatedat,pf.createdat,
        pd.pan_name,pd.pan_number,pd.aadhar_name,pd.aadhar_number,pd.contact_number,pd.emailid,
rd.premise_name,rd.flat_number,rd.road,rd.area,rd.village,rd.taluka,rd.district,rd.state,rd.pincode,pf.buss_name,
