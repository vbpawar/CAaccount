                        ...
                        <div class="col-sm-6 eq-box-sm">
                            <div class="panel">
                                ...
                                <form>
                                    <div class="panel-body">
                                        <div class="row">
                                        <div class="header"><strong>BUSINESS INFO</strong>
                                        </div>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="row">
                                        <div class="header"><strong>BUSINESS CONTACT</strong>
                                        </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                        <div class="header"><strong>PLACE OF BUSINESS</strong>
                                        </div>
                                        <div class="col-sm-4">
                                        ...
                                        <div class="row">
                                        <div class="header"><strong>RESIDENTIAL ADDRESS</strong>
                                        </div>
                                        <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label class="control-label">Flat/door/block no.</label>
