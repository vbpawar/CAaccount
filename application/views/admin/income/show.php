            ...
            <div class="boxed showDiv">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i> CA Certificate List</h3>
                        <div class="breadcrumb-wrapper">
                            <span class="label">You are here:</span>
                            <ol class="breadcrumb">
                                <li> <a href="#"> Home </a> </li>
                                <li class="active"> CA Certificate List</li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                            <a class="btn btn-primary" href="<?php echo base_url('services/Income/create');?> " role="button">Add New Entry</a>
                                <table  class="table table-striped table-bordered" id="service">
                                    <thead>
                                        <tr>
                                            <th class="min-tablet">User Id</th>
                                            <th class="min-tablet">Profession</th>
                                            <th class="min-tablet">Bussiness name</th>
                                            <th class="min-tablet">Premise name</th>
                                            <th class="min-tablet">Assesment year</th>
                                            ...
                                            <th class="min-tablet">DOB</th>
                                            <th class="min-tablet">Pan number</th>
                                            <th class="min-tablet">Father name</th>
                                            <th class="min-tablet">Email Id </th>
                                            <th class="min-tablet">Country </th>
                                            <th class="min-tablet">State </th>
                                            <th class="min-tablet">City </th>
                                            <th class="min-tablet">Flat </th>
                                            <th class="min-tablet">Road </th>
