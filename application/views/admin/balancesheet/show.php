            ...
            <div class="boxed showDiv">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i> Balancesheet List </h3>
                        <div class="breadcrumb-wrapper">
                            <span class="label">You are here:</span>
                            <ol class="breadcrumb">
                                <li> <a href="#"> Home </a> </li>
                                <li class="active"> Balancesheet List </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                            <a class="btn btn-primary" href="<?php echo base_url('services/balancesheet/create');?> " role="button">Add New Entry</a>
                                <table  class="table table-striped table-bordered" id="service">
                                    <thead>
                                        <tr>
                                            <th class="min-tablet">Name</th>
                                            <th class="min-tablet">Pancard No.</th>
                                            <th class="min-tablet">DOB</th>
                                            <th class="min-tablet">Mobile No.</th>
                                            <th class="min-tablet">Email Id</th>
                                            <th class="min-tablet">Projected Total Amount</th>
