                            ...
                            <div class="eq-height">
                                <div class="col-sm-6 eq-box-sm">
                                    <div class="panel">
                                        ...
                                        <!--Block Styled Form -->
                                        <!--===================================================-->
                                        <form id="balancesheetForm" name="balancesheetForm" method="post" enctype="multipart/form-data">
                                            <div class="panel-body">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="file" type="file" multiple name="adhar_attachement" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="file" type="file" name="pancard_attachment" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="file" class="form-control" placeholder="" name="last_year_balancesheet Copy">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
