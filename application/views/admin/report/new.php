                                        ...
                                        <form>
                                            <div class="panel-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label class="control-label">Bank Loan</label>
                                                            <input type="text" class="form-control" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label class="control-label">Own Capital</label>
                                                            <input type="text" class="form-control" placeholder="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label class="control-label">Loan Period(Year)</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label class="control-label">Repayment Schedule</label>
                                                    ...
                                                    <div class="col-sm-3" id="otherFieldGroupDiv">
                                                        <div class="form-group">
                                                            <label class="control-label">Repayment Attachment</label>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label class="control-label">Last Year Balance-sheet</label>
                                                    ...
                                                    <div class="col-sm-3" id="otherFieldGroupDiv2">
                                                        <div class="form-group">
                                                            <label class="control-label">Balance-sheet Attachment</label>
                                                            <input type="file" class="form-control" placeholder="as per Aadhar card">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="primary mobile no.">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
