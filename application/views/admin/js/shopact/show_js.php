<script>
    ...
    const loadList = () => {
        ...
        $.ajax({
            ...
            url: url + 'ShopAct/getallshopacts',
    ...
    const showList = serviceList => {
        ...
        for (let k of serviceList.keys()) {
            ...
            tblData += '<tr><td>' + services.userid + '</td>';
          
            tblData += '<td>' + services.s_mobile + '</td>';
            tblData += '<td>' + services.s_email + '</td>';
            tblData += '<td>' + services.s_status + '</td>';
