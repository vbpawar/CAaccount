...
<div class="boxed showDiv">
    ...
    <div id="content-container">
        ...
        <div class="pageheader">
            <h3><img src="<?php echo base_url('/admin_assets/img/withdraw_512x512.png'); ?>" /> Comapany Registration</h3>

            <div class="breadcrumb-wrapper">
                <span class="label">You are here:</span>
                <ol class="breadcrumb">
                    <li> <a href="#"> Home </a> </li>
                    <li class="active"> Comapany Registration </li>
                </ol>
            </div>
        </div>
        <!--Page content-->
        ...
        <div id="page-content">
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    if ($data['Data']['role'] == 3) {
                        echo '<a class="btn btn-primary" href="' . base_url() . 'companyregistration/create" role="button">Add New Entry</a>';
                    }
                    ?>
