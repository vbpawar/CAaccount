            ...
            <div class="boxed showDiv">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i> GST File List</h3>
                        <div class="breadcrumb-wrapper">
                            <span class="label">You are here:</span>
                            <ol class="breadcrumb">
                                <li> <a href="#"> Home </a> </li>
                                <li class="active"> GST File List</li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                    ...
                    if ($data['Data']['role'] == 3) {
                        echo '<a class="btn btn-primary" href="' . base_url() . 'creategstfile" role="button">Add New Entry</a>';
                    }
                    ?>
